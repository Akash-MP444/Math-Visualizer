/**
 * Marching Cubes: extracts an isosurface from a scalar field.
 * Algorithm ported faithfully from the original HTML implementation.
...
export const EDGE_TABLE: readonly number[] = [
  ...
  0x230,0x339,0x13,0x11a,0x636,0x73f,0x435,0x53c,0xa3c,0xb35,0x83f,0x936,0xe3a,0xf33,0xc39,0xd30,
  ...
  0xd30,0xc39,0xf33,0xe3a,0x936,0x83f,0xb35,0xa3c,0x53c,0x435,0x73f,0x636,0x11a,0x13,0x339,0x230,
  0xe90,0xf99,0xc93,0xd9a,0xa96,0xb9f,0x895,0x99c,0x69c,0x795,0x49f,0x596,0x29a,0x393,0x99,0x190,
  0xf00,0xe09,0xd03,0xc0a,0xb06,0xa0f,0x905,0x80c,0x70c,0x605,0x50f,0x406,0x30a,0x203,0x109,0x0,
];

export const TRI_TABLE: readonly (readonly number[])[] = [
  [-1],[0,8,3,-1],[0,1,9,-1],[1,8,3,9,8,1,-1],[1,2,10,-1],[0,8,3,1,2,10,-1],[9,2,10,0,2,9,-1],
  [2,8,3,2,10,8,10,9,8,-1],[3,11,2,-1],[0,11,2,8,11,0,-1],[1,9,0,2,3,11,-1],[1,11,2,1,9,11,9,8,11,-1],
  [3,10,1,11,10,3,-1],[0,10,1,0,8,10,8,11,10,-1],[3,9,0,3,11,9,11,10,9,-1],[9,8,10,10,8,11,-1],
  [4,7,8,-1],[4,3,0,7,3,4,-1],[0,1,9,8,4,7,-1],[4,1,9,4,7,1,7,3,1,-1],[1,2,10,8,4,7,-1],
  [3,4,7,3,0,4,1,2,10,-1],[9,2,10,9,0,2,8,4,7,-1],[2,10,9,2,9,7,2,7,3,7,9,4,-1],[8,4,7,3,11,2,-1],
  [11,4,7,11,2,4,2,0,4,-1],[9,0,1,8,4,7,2,3,11,-1],[4,7,11,9,4,11,9,11,2,9,2,1,-1],
  [3,10,1,3,11,10,7,8,4,-1],[1,11,10,1,4,11,1,0,4,7,11,4,-1],[4,7,8,9,0,11,9,11,10,11,0,3,-1],
  [4,7,11,4,11,9,9,11,10,-1],[9,5,4,-1],[9,5,4,0,8,3,-1],[0,5,4,1,5,0,-1],[8,5,4,8,3,5,3,1,5,-1],
  ...
  [10,3,11,10,1,3,9,5,4,-1],[4,9,5,0,8,1,8,10,1,8,11,10,-1],[5,4,0,5,0,11,5,11,10,11,0,3,-1],
  [5,4,8,5,8,10,10,8,11,-1],[9,7,8,5,7,9,-1],[9,3,0,9,5,3,5,7,3,-1],[0,7,8,0,1,7,1,5,7,-1],
  [1,5,3,3,5,7,-1],[9,7,8,9,5,7,10,1,2,-1],[10,1,2,9,5,0,5,3,0,5,7,3,-1],[8,0,2,8,2,5,8,5,7,10,5,2,-1],
  [2,10,5,2,5,3,3,5,7,-1],[7,9,5,7,8,9,3,11,2,-1],[9,5,7,9,7,2,9,2,0,2,7,11,-1],
  [2,3,11,0,1,8,1,7,8,1,5,7,-1],[11,2,1,11,1,7,7,1,5,-1],[9,5,8,8,5,7,10,1,3,10,3,11,-1],
  [5,7,0,5,0,9,7,11,0,1,0,10,11,10,0,-1],[11,10,0,11,0,3,10,5,0,8,0,7,5,7,0,-1],
  [11,10,5,7,11,5,-1],[10,6,5,-1],[0,8,3,5,10,6,-1],[9,0,1,5,10,6,-1],[1,8,3,1,9,8,5,10,6,-1],
  ...
  [5,10,6,1,9,2,9,11,2,9,8,11,-1],[6,3,11,6,5,3,5,1,3,-1],[0,8,11,0,11,5,0,5,1,5,11,6,-1],
  [3,11,6,0,3,6,0,6,5,0,5,9,-1],[6,5,9,6,9,11,11,9,8,-1],[5,10,6,4,7,8,-1],
  [4,3,0,4,7,3,6,5,10,-1],[1,9,0,5,10,6,8,4,7,-1],[10,6,5,1,9,7,1,7,3,7,9,4,-1],
  ...
  [0,7,3,0,10,7,0,9,10,6,7,10,-1],[10,6,7,1,10,7,1,7,8,1,8,0,-1],[10,6,7,10,7,1,1,7,3,-1],
  [1,2,6,1,6,8,1,8,9,8,6,7,-1],[2,6,9,2,9,1,6,7,9,0,9,3,7,3,9,-1],[7,8,0,7,0,6,6,0,2,-1],
  [7,3,2,6,7,2,-1],[2,3,11,10,6,8,10,8,9,8,6,7,-1],[2,0,7,2,7,11,0,9,7,6,7,10,9,10,7,-1],
  [1,8,0,1,7,8,1,10,7,6,7,10,2,3,11,-1],[11,2,1,11,1,7,10,6,1,6,7,1,-1],
  [8,9,6,8,6,7,9,1,6,11,6,3,1,3,6,-1],[0,9,1,11,6,7,-1],[7,8,0,7,0,6,3,11,0,11,6,0,-1],
  [7,11,6,-1],[7,6,11,-1],[3,0,8,11,7,6,-1],[0,1,9,11,7,6,-1],[8,1,9,8,3,1,11,7,6,-1],
  ...
  [10,7,6,1,7,10,1,8,7,1,0,8,-1],[0,3,7,0,7,10,0,10,9,6,10,7,-1],[7,6,10,7,10,8,8,10,9,-1],
  ...
  [3,6,11,0,6,3,0,5,6,0,9,5,-1],[0,11,8,0,5,11,0,1,5,5,6,11,-1],[6,11,3,6,3,5,5,3,1,-1],
  ...
  [8,2,0,8,5,2,8,7,5,10,2,5,-1],[9,0,1,2,3,5,3,7,5,-1],[1,8,2,1,9,8,2,8,5,7,5,8,-1],
  ...
  [4,11,7,4,9,11,9,10,11,-1],[0,8,3,4,9,7,9,11,7,9,10,11,-1],[1,10,11,1,11,4,1,4,0,7,4,11,-1],
...
function interp(p1: Vec3, v1: number, p2: Vec3, v2: number, iso: number): Vec3 {
  if (Math.abs(v1 - v2) < 1e-10) return [...p1] as Vec3;
...
/**
 * Run marching cubes on a scalar field function.
 * @param fn - scalar field evaluator
 * @param range - world-space half-extent of the cube
...
export function marchingCubes(
  ...
  const grid = new Float32Array((N + 1) ** 3);
  for (let iz = 0; iz <= N; iz++) {
    for (let iy = 0; iy <= N; iy++) {
      for (let ix = 0; ix <= N; ix++) {
        ...
        const v = fn(x, y, z);
        grid[iz * (N + 1) * (N + 1) + iy * (N + 1) + ix] = isFinite(v) ? v : 1e10;
      }
    }
    if (onProgress) onProgress(Math.round((iz / N) * 90));
  }

  function gidx(ix: number, iy: number, iz: number): number {
  ...
  for (let iz = 0; iz < N; iz++) {
    for (let iy = 0; iy < N; iy++) {
      for (let ix = 0; ix < N; ix++) {
        ...
        let cubeIdx = 0;
        for (let i = 0; i < 8; i++) if ((vals[i] ?? 0) < isoLevel) cubeIdx |= (1 << i);

        const edgeMask = EDGE_TABLE[cubeIdx] ?? 0;
        if (edgeMask === 0) continue;

        const vList = new Array<Vec3 | null>(12).fill(null);
        if (edgeMask & 1)    vList[0]  = interp(pts[0]!, vals[0]!, pts[1]!, vals[1]!, isoLevel);
        if (edgeMask & 2)    vList[1]  = interp(pts[1]!, vals[1]!, pts[2]!, vals[2]!, isoLevel);
        if (edgeMask & 4)    vList[2]  = interp(pts[2]!, vals[2]!, pts[3]!, vals[3]!, isoLevel);
        if (edgeMask & 8)    vList[3]  = interp(pts[3]!, vals[3]!, pts[0]!, vals[0]!, isoLevel);
        if (edgeMask & 16)   vList[4]  = interp(pts[4]!, vals[4]!, pts[5]!, vals[5]!, isoLevel);
        if (edgeMask & 32)   vList[5]  = interp(pts[5]!, vals[5]!, pts[6]!, vals[6]!, isoLevel);
        if (edgeMask & 64)   vList[6]  = interp(pts[6]!, vals[6]!, pts[7]!, vals[7]!, isoLevel);
        if (edgeMask & 128)  vList[7]  = interp(pts[7]!, vals[7]!, pts[4]!, vals[4]!, isoLevel);
        if (edgeMask & 256)  vList[8]  = interp(pts[0]!, vals[0]!, pts[4]!, vals[4]!, isoLevel);
        if (edgeMask & 512)  vList[9]  = interp(pts[1]!, vals[1]!, pts[5]!, vals[5]!, isoLevel);
        if (edgeMask & 1024) vList[10] = interp(pts[2]!, vals[2]!, pts[6]!, vals[6]!, isoLevel);
        if (edgeMask & 2048) vList[11] = interp(pts[3]!, vals[3]!, pts[7]!, vals[7]!, isoLevel);

        const tris = TRI_TABLE[cubeIdx] ?? [-1];
        for (let i = 0; i < tris.length; i += 3) {
          if ((tris[i] ?? -1) === -1) break;
          const a = vList[tris[i]!], b = vList[tris[i + 1]!], c = vList[tris[i + 2]!];
          if (!a || !b || !c) continue;
